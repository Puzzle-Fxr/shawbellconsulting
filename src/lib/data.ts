...
export const people = [
  ...
  },
  {
    ...
    details: [
      "Estelle Appiah is qualified to practice law in the UK, Ghana and Lesotho. Her legal qualifications are from the University of London, the University of Ghana and the University of the West Indies.<br /><br />\
      The key skills of Estelle Appiah are the drafting of substantive and subsidiary legislation, legal research, policy formulation and the preparation of reports. Estelle Appiah has prepared Legislative drafting manuals for the Commonwealth Secretariat, the Senate of the Parliament of Kenya and the Directorate, Legislative Drafting, Ministry of Justice, Namibia. She has strong communication skills and has frequently facilitated stakeholder meetings on policy, legislation and ancillary matters.<br /><br />\
