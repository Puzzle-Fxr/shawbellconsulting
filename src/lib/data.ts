...
export const people = [
  ...
  },
  {
    ...
    qualifications: ["<ul><li>▪ Bachelor of Arts (BA) from Brandeis University</li><li>▪ Master of Business Administration (MBA) from the University of Rochester</li><li>▪ Doctorate (PhD) from New York University</li></ul>"],
    details: [
  ...
  },
  {
    ...
    details: [
      "Oheneba Kwadwo Darteh is a lawyer at ShawbellConsulting Limited, a distinguished consulting firm specializing in policy and legal consultancy. With a strong academic foundation in Ghanaian law, Oheneba brings a wealth of knowledge to the firm’s diverse practice areas, including Regulation and Legal Due Diligence, Compliance and Governance Reviews, Company and Commercial Practice, Alternative Dispute Resolution and Corporate Law.<br /><br />\
      Oheneba is a highly motivated and detail-oriented lawyer with a strong commitment to delivering excellent legal and consulting services to both local and international clients, while upholding the highest standards of professionalism. He is skilled in legal research, drafting and advocacy, with the ability to analyse complex issues and develop effective strategies. Before joining the firm, he held negotiations with Governmental Agencies such as the National Petroleum Authority.<br /><br />\
      His dedication to excellence and his commitment to upholding the principles of justice and equity underscore his professional approach to legal practice. Oheneba's passion for the law, combined with his practical experience and academic rigor, positions him as a trusted advisor and advocate for prospective clients. He continues to play a vital role in advancing the firm’s mission to deliver exceptional legal and policy solutions.",
    ],
  },
  {
    id: 'johanna-ntow',
  ...
  },
  {
    ...
    qualifications: ['<ul><li>▪ Bachelor of Science in Biological Sciences (BSc.), Kwame Nkrumah University of Science and Technology(KNUST) - Ghana (2020)  </li><li>▪ Masters of Public Health (MPH), University of Ghana (2026-In Progress) </li><li>▪ Research support for business development and proposal development</li><li>▪ Health-sector research and quality assurance (clinical and public-health oriented)</li><li>▪ Maintenance and organization of research library; evidence-based reporting</li></ul>'],
    details: [
...
export const clients = [
  ...
  {
   name: 'Ministry of Ghana National Petroleum Corporation',
   logo: "images/logo/gnpc.png",
  },
  {
   name: 'Ghana Coco Board (Cocobod)',
