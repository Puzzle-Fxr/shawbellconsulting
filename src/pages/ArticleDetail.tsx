    ...
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <h2 className="font-heading font-bold text-2xl text-steel mb-4">Article Not Found</h2>
          <Link to="/articles" className="text-ocean font-heading font-medium">← Back to Articles</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="page-enter">
      ...
      <section className="bg-white py-16 lg:py-24">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-600 leading-relaxed mb-6 text-lg">{article.excerpt}</p>
          ...
          <div className="pt-8 border-t border-platinum">
            <Link to="/articles" className="inline-flex items-center gap-2 text-steel font-heading font-medium hover:text-ocean transition-colors">
      ...
      <section className="bg-platinum/30 py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 max-w-xl mx-auto mb-6">Our consultants can provide deeper insight and practical guidance on the issues discussed in this article.</p>
          <Link
            to="/contact"
