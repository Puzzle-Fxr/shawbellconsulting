    ...
    <section className="bg-gradient-to-r from-steel to-steel-dark py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-ocean-light font-heading font-medium text-sm uppercase tracking-wider mb-2">Latest Article</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link to="/articles" className="text-sm text-gray-500 hover:text-ocean transition-colors">Articles</Link>
