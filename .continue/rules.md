...
- Prefer updating or extending the exported arrays in `src/lib/data.ts` for service, article, person, and partner content rather than hard-coding page-local content.
